"""
Plot a graph of model.gamma.
Usage:
  gamma_visualizer.py [-c <corpus>]
  gamma_visualizer.py -h | --help
Options:
...
from languagemodeling.ngram import InterpolatedNGram as INGram
